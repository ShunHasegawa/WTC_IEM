...
<<Fig_WTC_IEM_Ammonium_Temp, echo=FALSE, fig.height=3, fig.width=6>>=
TrtFg[[2]]
@
...
<<Stat_WTC_IEM_Ammonium_Smmry, echo=TRUE, results='markup'>>=
@
...
<<Fig_WTC_IEM_Ammonium_Chamber, echo=FALSE, fig.height=3.5, fig.width=6>>=
# ring_Phosphate
ChFg[[2]]
@
