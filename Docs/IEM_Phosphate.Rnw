...
<<Fig_WTC_IEM_Phosphate_Temp, echo=FALSE, fig.height=3, fig.width=6>>=
TrtFg[[3]]
@
...
<<Stat_WTC_IEM_Phosphate_Smmry, echo=TRUE, results='markup'>>=
@
...
<<Fig_WTC_IEM_Phosphate_Chamber, echo=FALSE, fig.height=3.5, fig.width=6>>=
# ring_Phosphate
ChFg[[3]]
@
