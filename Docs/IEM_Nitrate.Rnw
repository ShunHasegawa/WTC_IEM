...
<<Fig_WTC_IEM_Nitrate_Temp, echo=FALSE, fig.height=3, fig.width=6>>=
TrtFg[[1]]
@
...
% %%%%%%%%%%%%%
% 
% <<Stat_WTC_IEM_Nitrate_Smmry, echo=TRUE, results='markup'>>=
% @
...
<<Fig_WTC_IEM_Nitrate_Chamber, echo=FALSE, fig.height=3.5, fig.width=6>>=
# ring_Phosphate
ChFg[[1]]
@
